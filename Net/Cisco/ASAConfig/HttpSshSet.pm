package Net::Cisco::ASAConfig::HttpSshSet;
...
Net::Cisco::ASAConfig::HttpSshSet 
...
Perhaps a little code snippet.
    ...
    use Net::Cisco::ASAConfig::HttpSshSet;

    my $foo = Net::Cisco::ASAConfig::HttpSshSet->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Net::Cisco::ASAConfig::HttpSshSet
...
sub new {
    # creates new HttpSshList object, which contains all the http and ssh management access objects
    my $class = shift;
    my $self = {};
    bless $self, $class;
...
1; # End of Net::Cisco::ASAConfig::HttpSshSet
